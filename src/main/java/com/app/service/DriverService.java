...
public interface DriverService {
    ...
    DriverAvailabilityDTO markForNoRide(String driverId) throws InvalidInputException, DriverAvailableException, EntityNotFoundException, InternalServerException, DriverSignInOutException, InvalidOnboardingStepException;
